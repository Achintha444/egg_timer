...
class RadialDragGestureDetectorModel extends StatefulWidget {
  ...
  RadialDragGestureDetectorModel({
  ...
  @override
  _RadialDragGestureDetectorModelState createState() => new _RadialDragGestureDetectorModelState();
}

class _RadialDragGestureDetectorModelState extends State<RadialDragGestureDetectorModel> {
